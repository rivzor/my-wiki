...
??? question "Что за фильтры?"
    ...
    5. **RU AdList Counters / BitBlock** — доп. фильтры для счётчиков и визуального мусора.
    6. **RU AdList Counters / BitBlock** — доп. фильтры для счётчиков и визуального мусора.
